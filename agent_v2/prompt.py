...
FAULT_CONTENT_COMMON_PROMPT_V1 = (
    ...
    Based on the provided {directory} and {language}, we will generate detailed content for the fault analysis report using Markdown syntax format. Here are the steps for generating the content:
